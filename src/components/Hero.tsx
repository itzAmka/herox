  ...
  return (
    <section className="flex flex-col gap-12">
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <Image src="https://images.unsplash.com/photo-1611241893603-3c359704e0ee?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80" alt="hero" width={200} height={200} className="w-full h-80"/>
        <Image src="https://images.unsplash.com/photo-1515378960530-7c0da6231fb1?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80" alt="hero"  width={200} height={200} className="w-full h-80"/>
      </div>
    </section>
  )
}
